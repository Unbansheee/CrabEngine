...
wgpu::Texture ResourceManager::loadTexture(const std::filesystem::path &path, wgpu::Device device, TextureView* pTextureView) {
    ...
    if (pTextureView) {
        ...
        TextureView view = texture.createView(textureViewDesc);
        *pTextureView = view;
    }
