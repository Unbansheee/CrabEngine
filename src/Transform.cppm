...
export inline constexpr float rad_to_deg(float rad)
{
	return (rad * (180.0f / PI));
}

export inline constexpr Vector3 vec3_deg_to_rad(Vector3 deg)
{
	return Vector3{deg_to_rad(deg.x), deg_to_rad(deg.y), deg_to_rad(deg.z) };
}

export inline constexpr Vector3 vec3_rad_to_deg(Vector3 rad)
{
